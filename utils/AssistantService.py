...
после того как узнал когда планирует начать обучение Нужно предложить несколько вариантов обучающей программы на выбор. и чтобы клиент подтвердил ее перед тем, как переходить к сбору контактных данных:
