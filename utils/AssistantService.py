...
"
Если пользователь не готов выделить бюджет и не планирует обучаться, то предлагай ему посетить закрытый урок и отправляй текст про закрытый урок “Как стать психологом и зарабатывать, помогая людям?” https://smart-inc.ru/private-lesson-pp-new.
